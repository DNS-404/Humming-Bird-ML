...
public class FlowerArea : MonoBehaviour
{
    ...
    /// </summary>
    public List<Flower> Flowers { get; private set; } // can get from outside but can be set only from this file
    ...
    /// <summary>
    /// Recusively finds all flowers and flower plants that are children of a parent transform
    /// </summary>
